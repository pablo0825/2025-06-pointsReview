...
本文件描述申請、簽核、補件、審核、逾期與點數異動的行為流程。第一版完成一般申請至核准的正式流程；核准後點數異動與沖銷延後到第二版。相關資料表與欄位請參考 [資料模型](data-model.md)。
...
- 承辦人不可直接異動或沖銷核准後點數。第一版不開放核准後更正 API；第二版才提供承辦人提出點數異動申請、管理員核准後建立新流水帳紀錄的流程。
